...
/// Decodes AI SDK UI `UIMessage[]` JSON into AIKit `ChatMessage[]`.
///
/// Source of truth:
/// - `ai-sdk/packages/ai/src/ui/ui-messages.ts`
/// - `ai-sdk/packages/ai/src/ui/validate-ui-messages.ts`
    ...
    for message in messages {
      ...
      for (index, partValue) in message.parts.enumerated() {
        ...
        default:
          ...
          // Preserve forward compatibility by ignoring unknown parts (AI SDK validation would reject, but decoding can be looser).
          continue
        }
      }
