...
/// Typed representation of the Vercel AI SDK **UI message stream protocol** (SSE v1) parts.
///
/// Source of truth:
...
public enum AIUIMessageStreamPart: Sendable, Equatable {
  ...
  /// A `data-*` chunk as defined by the AI SDK UI message stream protocol.
  ///
  /// Source of truth:
  /// `ai-sdk/packages/ai/src/ui-message-stream/ui-message-chunks.ts` (`DataUIMessageChunk`)
