...
/// Swift analogue to the UI `ChatTransport` interface used by `useChat`.
///
...
public struct ChatTransportSendMessagesOptions: Sendable {
  ...
  /// `messageId` (used for regenerate flows).
  public var messageID: String?

  /// Mirrors `ChatRequestOptions` (headers/body/metadata).
  public var options: ChatRequestOptions?

  /// Mirrors `abortSignal` use cases (optional).
